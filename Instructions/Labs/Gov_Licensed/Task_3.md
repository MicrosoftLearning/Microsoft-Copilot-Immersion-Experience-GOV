...
lab:
  ...
  description: In this task, you’ll use Microsoft 365 Copilot Chat (Copilot Chat)
    ...
    a specific topic. This helps you quickly catch up on recent communications, ensuring
    you’re well-prepared to follow up. Then, you’ll switch to Outlook to draft a follow-up
    email using Copilot in Outlook, allowing you to respond promptly and effectively
